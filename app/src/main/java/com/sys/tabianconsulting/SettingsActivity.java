...
import com.sys.tabianconsulting.utility.FilePaths;
    ...
    private void executeUploadTask(){
        ...
        if (mBytes.length/MB <MB_THRESHHOLD){
            StorageMetadata metadata = new StorageMetadata.Builder()
                    ...
                    .setCustomMetadata("Meta", "Nothing Special")
                    .setCustomMetadata("location", "Island")
                    .build();
                    ...
                    Task<Uri> firebaseURL = taskSnapshot.getMetadata().getReference().getDownloadUrl()
                            .addOnSuccessListener(new OnSuccessListener<Uri>() {
                                ...
                                public void onSuccess(Uri uri) {
                                    ...
                                    Toast.makeText(SettingsActivity.this, "Firebase Download Url: " + uri, Toast.LENGTH_SHORT).show();
                                }
                            });
